...
year1 = 2004; year2 = 2016;G="Male";country="ITA"

Final %>% filter(CNT==country) %>% View()
Final %>% filter(CNT=="NLD") %>% View()
...
Sullivan.fun(rates=mxwx1,sex = G)
## [1] 9.691796
# In 1990 it was
Sullivan.fun(rates=mxwx2,sex = G)
